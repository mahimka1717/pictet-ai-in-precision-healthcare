...
export default function Footer_ft() {
  return (
    <>
            ...
            <div className="o-footer__container">
                ...
                <nav className="o-footer__matrix" role="navigation" aria-label="Useful links">
                    ...
                    <div className="o-footer__matrix-content" id="o-footer-section-2">
                        ...
                        <a className="o-footer__matrix-link" href="//enterprise.ft.com/en-gb/services/group-subscriptions/">Group
                            Subscriptions</a>
                        <a className="o-footer__matrix-link" href="//enterprise.ft.com/en-gb/services/republishing/">Republishing</a>
                        <a className="o-footer__matrix-link" href="//www.businessesforsale.com/ft2/notices">Contracts &amp;
                            Tenders</a>
                        ...
                        <a className="o-footer__matrix-link" aria-label="Advertise with the F T" href="//fttoolkit.co.uk/d/">Advertise
                            with the FT</a>
                        <a className="o-footer__matrix-link" aria-label="Follow the F T on Twitter" href="//twitter.com/ft">Follow
                            the FT on Twitter</a>
                        </div>
                    </div>
                    </div>
                    ...
                    <div className="o-footer__matrix-content" id="o-footer-section-3">
                        ...
                        <div className="o-footer__matrix-column">
                        <a className="o-footer__matrix-link" href="//markets.ft.com/Research/Economic-Calendar">Economic
                            Calendar</a>
                ...
                <h6 className="o-footer__external-link o-footer__matrix-title">
                    <a className="o-footer__more-from-ft o-footer__matrix-title" href="http://ft.com/more-from-ft-group">More
                    from the FT Group</a>
                </h6>
                </div>
                ...
                <small>
                    ...
                    <abbr title="Financial Times" aria-label="F T">FT</abbr> and ‘Financial Times’ are trademarks
                    of The Financial Times Ltd.<br />
                    The Financial Times and its journalism are subject to a self-regulation regime under the <a href="https://aboutus.ft.com/en-gb/ft-editorial-code/" aria-label="F T Editorial Code of Practice">FT
                    Editorial Code of Practice</a>.
                </small>
                </div>
            </div>
        ...
        <script async type="application/javascript" src="https://www.ft.com/partnercontent/cms/_resources/themes/simpleBC/dist/main-bundle.js?m=1628000569"></script>
    </>
  )
}
